...
- Browser workspace persistence and private named views stored in LibreNMS. Views capture device-group/root/site/search filters, backbone and other-device visibility, positions, pins, zoom and pan. The explicit demo stores named views in this browser only.
